...
const instagramPosts = [
  {
    id: 1,
    image: '/resources/header_02.jpeg',
    caption: '🎸 Dante en su segunda versión',
    likes: 234,
    comments: 15,
    timestamp: '2h'
  },
  ...
  {
    id: 3,
    image: '/resources/media_001.jpeg',
    caption: '🎵 Arte - Excel. Por Eli',
    likes: 156,
    comments: 12,
    timestamp: '1d'
  },
  {
    id: 4,
    image: '/resources/media_002.jpeg',
    caption: '🎤 Primera media',
    likes: 278,
    comments: 22,
  ...
  {
    id: 6,
    image: '/resources/integrante_02.png',
    caption: '🎵 Lindos tiempos e inicios.',
    likes: 167,
    comments: 9,
    timestamp: '3 años atrás'
  },
  {
    id: 7,
    image: '/resources/media_004.png',
    caption: '💫 Momentos antes de subir al escenario #backstage #concert #nervios',
    likes: 198,
    comments: 14,
    timestamp: '7 meses atrás'
  },
  {
    id: 8,
    image: '/resources/media_005.png',
    caption: '🎼 Componiendo en Escuela México Aguas de la Gloria',
    likes: 134,
    comments: 7,
    timestamp: '1 año atrás'
  },
  {
    id: 9,
    image: '/resources/media_006.png',
    caption: '✨ En las palmeras del humedal, para el mundo',
    likes: 223,
    comments: 16,
    timestamp: '2 de septiembre 2025'
  }
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-linear-to-r from-purple-500 to-pink-500 text-white px-6 py-3 rounded-full font-semibold hover:from-purple-600 hover:to-pink-600 transition-all duration-300"
          >
